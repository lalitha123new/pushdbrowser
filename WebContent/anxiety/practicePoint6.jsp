...
<body class="bgcolor" oncontextmenu="return false">
											...
											if(data!= null){
												...
												for (j = 0; j < arr['questions'].length; j++) {
													...
													for (var k = 0; k < arr1.length; k++) {
														...
														exer += '<input type="text" class=" form-control" value="'+ MultiArray[0][k] +' " disabled>'+ 
														'</input>'+
															    '</div>';
											...
											if(data!= null){
												...
												for (j = 0; j < arr['questions'].length; j++) {
													...
													for (var k = 0; k < arr1.length; k++) {
														...
														exer += '<input type="text" class=" form-control" value="'+ MultiArray[0][j] +' " disabled>'+ 
														'</input>'+
															    '</div>';
											...
											if(data!= null){
												...
												for (j = 0; j < arr['questions'].length; j++) {
													...
													for (var k = 0; k < arr1.length; k++) {
														...
														exer += '<input type="text" class=" form-control" value="'+ MultiArray[j][k] +' " disabled>'+ 
														'</input>'+
	...
	/* function checkForEmptyFields()
	{
		...
		for (j = 1; j <= count; j++)	{
			...
			for (k = 1; k <= cArr[j-1]; k++) {
				...
				if($('.bl-'+activeSectionId+'-'+activeSubSectionId+'-'+j+'-'+k).val()) {
					...
					formData += j + '_' + k + '_' + $('.bl-'+activeSectionId+'-'+activeSubSectionId+'-'+j+'-'+k).val() + ',';
					
					temp_array.push($('.bl-'+activeSectionId+'-'+activeSubSectionId+'-'+j+'-'+k).val());
					
					//formData1[j] += $('.bl-'+activeSectionId+'-'+activeSubSectionId+'-'+j+'-'+k).val() + '#@@#';
		...
		if(flag == true){
			...
			if(minfields==1)
				alert("Please fill atleast one blank to continue");
	...
	//old code as pdf file
	 function download1() {
	        	...
	        	if(arr_splitted_data1== null){
	        	 ...
	        	 if(arr_splitted_data1== null){
					...
					//pdf.text(15, 25, 'Practice Point2');
	        		 ...
	        		 source = $('#exercise')[0]; 
	        		 pdf.setFontSize(11);
	        		 /* pdf.text(35, 300, arr_splitted_data1_new[0][0]); */
	        ...
	        specialElementHandlers = {
		            ...
		            // element with id of "bypass" - jQuery style selector(not include the given id part in the pdf)
	 ...
	 function download(){
		    ...
		    return (sa);
		    		...
		    		if(arr_splitted_data1== null){
				    	...
				    	"<td>"+"Write down how you might respond to this worry when you are in emotional mind-state:"+"</td><td>"+
