...
<body class="bgcolor" oncontextmenu="return false">
		...
		<div class="col-md-11">
			<div class="">
				...
				<div class="col-md-10 col-sm-8">
					<div class="row">
						<h3><b id="subsection-name">3.7  Practice Point : Your weekly monitor</b></h3>
	...
	<div class="row">
		...
		<div class="col-md-2">
		<!-- next button code for old code -->
			<!-- <div id="next" class="alert alert-info text-center" role="alert">	</div>-->
			
			<!-- new code for next button -->
			 <div id="next">
