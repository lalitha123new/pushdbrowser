...
<body>
	...
	<div class="col-md-12">
		...
		<div class="col-md-1" style="padding: 10px 0px 0px 25px;">
			...
			<a href="doctorUsers.jsp" type="button" class="btn btn-success" data-toggle="tooltip" data-placement="top" title="Home">
		...
		<div class="col-md-1" style="padding: 10px 0px 0px 5px;">
			<a href="doctorWorkBook.jsp?userid=<%=request.getParameter("userid")%>" type="button" class="btn btn-success"
