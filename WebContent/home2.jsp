		...
		<div class="row">
			...
			<div class="col-md-10">
				...
				<div class="col-md-10" id="0">
					...
					<p><strong>ESSENTIAL ZONE:</strong></p><br>
					<p>The <strong>essential zone</strong> contains sections which are mandatory for you to complete. These follow a pre-designed sequence. These sections cover techniques/approaches that are commonly useful for most individuals dealing with depression. Your journey through this zone is depicted in the diagram given below.

					</p>
					<p><strong>OPTIONAL ZONE:</strong></p><br>
				...
				<div class="col-md-10 hidden text-justify" id="1">
					...
					<div class="row">
						...
						<div class="col-md-8">
							...
							Learning anything involves ups and downs. It is
							useful to keep track of our efforts during our journey of
							learning. This helps us to push ourselves as well as
							reminds us that we are doing alright. <br> Progress
							tracker focuses on your efforts and not on outcomes. This
							is because, focusing on efforts (rather than worrying about
							and waiting for outcomes) and rewarding oneself for ,making small efforts 
							is the best approach to keep up one's motivation.
				...
				<div class="col-md-11 hidden text-justify" id="3">
					...
					<p>The diagnosis and treatment of clinical depression and
						...
						professional. The Site is not designed to â€˜treatâ€™ common
					...
					<p>You agree to assume total responsibility and risk for
						...
						service and the content are provided on an 'as is' and '€œas
					...
					<p>
						...
						to your computerâ€™s hard disk when you open the program
						pages. Cookies by themselves do not identify you or any user
						but they do identify your browser. Because this Site uses €˜transient cookies, your computer does not retain the
					...
					<p>Links to external websites on the Program are provided
						...
						NIMHANS or PUSH â€“D Team is not responsible for the
				...
				<div class="col-md-4" align="right">
					<a href="#" id="chk1"
						...
						<a  id="chk3" href="redirect.jsp" class="hidden btn btn-info btn-block text-center"
						data-toggle="tooltip" data-placement="bottom"
